<div class="max-w-xl mx-auto mt-10 p-6 bg-white rounded-xl shadow-md">
    ...
    <form wire:submit.prevent="save" class="space-y-5">
        ...
        <div>
            ...
            <textarea wire:model.defer="body" id="body" rows="4" class="mt-1 block w-full text-gray-700 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"></textarea>
